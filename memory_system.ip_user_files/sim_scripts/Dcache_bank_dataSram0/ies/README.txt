...
#
# Generated by export_simulation on Mon Jul 15 21:37:56 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './Dcache_bank_dataSram0.sh' script.

./Dcache_bank_dataSram0.sh -reset_run
...
./Dcache_bank_dataSram0.sh -noclean_files

For more information on the script, please type './Dcache_bank_dataSram0.sh -help'.
