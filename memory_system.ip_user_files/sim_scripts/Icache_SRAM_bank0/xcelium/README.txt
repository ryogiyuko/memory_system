...
#
# Generated by export_simulation on Thu Jul 11 19:30:34 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './Icache_SRAM_bank0.sh' script.

./Icache_SRAM_bank0.sh -reset_run
...
./Icache_SRAM_bank0.sh -noclean_files

For more information on the script, please type './Icache_SRAM_bank0.sh -help'.
