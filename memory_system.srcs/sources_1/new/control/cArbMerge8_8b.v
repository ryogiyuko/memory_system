...
input [7:0] i_data0 ,i_data1 ,i_data2 ,i_data3 ,i_data4 ,i_data5 ,i_data6 ,i_data7 ;
input i_freeNext;
input rst;
...
(* dont_touch="true" *)wire [7:0] w_data0 ,w_data1 ,w_data2 ,w_data3 ,w_data4 ,w_data5 ,w_data6 ,w_data7 ;
(* dont_touch="true" *)wire [7:0] w_data ;
(* dont_touch="true" *)wire [7:0] w_priority_8;
(* dont_touch="true" *)reg [7:0] r_data0 ,r_data1 ,r_data2 ,r_data3 ,r_data4 ,r_data5 ,r_data6 ,r_data7 ;
(* dont_touch="true" *)reg [7:0] r_data ;
...
//Mux
(* dont_touch="true" *)assign w_data  = (w_validation_8 == 8'b00000001) ? w_data0  :
										 ((w_validation_8 == 8'b00000010) ? w_data1  : 
										 ((w_validation_8 == 8'b00000100) ? w_data2  :
										 ((w_validation_8 == 8'b00001000) ? w_data3  :
										 ((w_validation_8 == 8'b00010000) ? w_data4  : 
										 ((w_validation_8 == 8'b00100000) ? w_data5  :
										 ((w_validation_8 == 8'b01000000) ? w_data6  :	
										 ((w_validation_8 == 8'b10000000) ? w_data7  : 8'b0 )))))));
