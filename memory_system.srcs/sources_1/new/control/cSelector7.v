...
module cSelector7(//condfork,注意valid用o_fire结合触发器稳定住再输入
    input       rst,         
    input       i_drive,
    output      o_free,
    output      o_fire,
...
assign w_freeNext = i_freeNext0 | i_freeNext1 | i_freeNext2 | i_freeNext3 | i_freeNext4 | i_freeNext5 | i_freeNext6 ;
