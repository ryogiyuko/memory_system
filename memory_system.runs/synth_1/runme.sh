...
HD_PWD='D:/github/memory_system/memory_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dcache_D_V_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dcache_D_V_buffer.tcl
