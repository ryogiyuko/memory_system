...
HD_PWD='D:/github/memory_system/memory_system.runs/Icache_SRAM_bank_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Icache_SRAM_bank.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Icache_SRAM_bank.tcl
