...
HD_PWD='D:/github/memory_system/memory_system.runs/Dcache_bank_dataSram0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dcache_bank_dataSram0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dcache_bank_dataSram0.tcl
